<?php
namespace Sunarc\Splitorderpro\Model\Plugin\Quote;
...
class QuoteToOrderItem
{
    ...
    public function aroundConvert(
        ...
        $orderItem->setSplitAttributeValue($item->getSplitAttributeValue());
        $orderItem->setSplitAttributeCode($item->getSplitAttributeCode());
